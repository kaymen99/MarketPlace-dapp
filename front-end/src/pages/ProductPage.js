                ...
                <div className='col-md-7 text-center p-3'>
                    <div className='p-3'>
                        {Number(productState.buy_price_in_ETH) === 0 ? (
                            <div>
                                Sale of <b>{productState.name}</b> for <b>{parseFloat(productState.price_eth).toFixed(4)} ETH</b>
                            </div>
                        ) : (
                            <div>
                                <b>{productState.name}</b> bought for <b>{parseFloat(productState.buy_price_in_ETH).toFixed(4)} ETH</b>
                            </div>
                        )}
                        ...
                        {data.account === productState.seller ? (
                            productState.status === "IN SALE" ? (
                                ...
                                productState.status === "PENDING" ? (
                                    <Button variant="primary" onClick={() => { send(id) }}>
                            ...
                            productState.status === "IN SALE" ? (
                                <Button variant="primary" onClick={() => { purchase(id) }}>
                                ...
                                productState.status === "PENDING" ? (
                                    <>
                                        ...
                                        <Button variant="primary" onClick={() => { cancel(id) }}>
                        ...
                        <tbody>
                            ...
                            {Number(productState.buy_price_in_ETH) === 0 ? (
                                ...
                                <tr>
                                    ...
                                    <td>{parseFloat(productState.buy_price_in_ETH).toFixed(5)} ETH</td>
                                </tr>
                            )}
                            <tr>
